...
<body class="container">
  ...
  <a class="change-menu" href="/es-restaurante/src/view/cardapioTipo/index.php">Ir para cardápio de tipos</a>

  <?php

  include_once $_SERVER['DOCUMENT_ROOT'] . '/es-restaurante/src/controller/pratos.php';
  include_once $_SERVER['DOCUMENT_ROOT'] . '/es-restaurante/src/controller/registro_de_compras_prato.php';

  include_once $_SERVER['DOCUMENT_ROOT'] . '/es-restaurante/src/model/cardapio.class.php';

  $pratos = fetchPratos();
  $registros = fetchRegistrosPrato('1');
  $cardapio = new Cardapio();
  $cardapioOrdenado = $cardapio->getCardapioOrdenadoPrato($pratos, $registros);
  ?>
